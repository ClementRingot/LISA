...
- **Version bumps are now driven by [Changesets](https://github.com/changesets/changesets).**
  ...
  `package.json`, and the extension's `plugin.version`. Because `@lisa/core` is bundled into both
  the server and the extension, the guard also requires a `packages/core/src` change to bump **both**
  `lisa-server` and `lisa-arc1-extension`. The two cadences keep their namespaced tags
...
[0.8.2]: https://github.com/ClementRingot/LISA/compare/v0.8.1...v0.8.2
[0.8.1]: https://github.com/ClementRingot/LISA/compare/v0.8.0...v0.8.1
[0.8.0]: https://github.com/ClementRingot/LISA/compare/v0.7.1...v0.8.0
[0.7.1]: https://github.com/ClementRingot/LISA/compare/v0.7.0...v0.7.1
