...
METHODS get_ddls_field_attr IMPORTING iv_name TYPE string iv_position TYPE i DEFAULT 1 RETURNING VALUE(ro_attr) TYPE REF TO cl_xco_ddef_fld_text_attribute.
...
METHODS build_text_json_entry
    ...
    CLASS-METHODS json_join
      ...
      RETURNING VALUE(rv_json) TYPE string.
METHODS get_anno_slots IMPORTING iv_entity_name TYPE string iv_ddlx TYPE abap_bool DEFAULT abap_false RETURNING VALUE(rt_slots) TYPE string_table.
...
METHODS get_me_entity_attr IMPORTING iv_name TYPE string iv_position TYPE i DEFAULT 1 RETURNING VALUE(ro_attr) TYPE REF TO cl_xco_me_ent_text_attribute.
...
METHOD handle_set_translation.
    ...
    TRY.
        ...
        CASE lv_target_type.
          ...
          WHEN 'domain'.
            DATA(lo_dom_set) = xco_cp_i18n=>target->domain->fixed_value( iv_domain_name = CONV sxco_ad_object_name( lv_object_name ) iv_lower_limit = CONV if_xco_domain_fixed_value=>tv_lower_limit( lv_fixed_value ) ).
          ...
          WHEN 'text_pool'.
            ...
            IF lv_pool_type = 'function_group'.
              DATA(lo_fg_set) = xco_cp_i18n=>target->text_pool->function_group_text_symbol( iv_function_group_name = CONV sxco_fg_object_name( lv_object_name ) iv_text_symbol_id = CONV if_xco_cp_i18n_tp_target_fctry=>tv_text_symbol_id( lv_text_sym_id ) ).
              lo_fg_set->set_translation( it_texts = lt_tp_texts io_language = lo_language io_change_scenario = lo_change_scenario ).
            ELSE.
              DATA(lo_cls_set) = xco_cp_i18n=>target->text_pool->class_text_symbol( iv_class_name = CONV sxco_ao_object_name( lv_object_name ) iv_text_symbol_id = CONV if_xco_cp_i18n_tp_target_fctry=>tv_text_symbol_id( lv_text_sym_id ) ).
          ...
          WHEN 'metadata_extension'.
            ...
            " written with one set_translation under the shared change scenario.
            ...
            LOOP AT lt_me_groups INTO DATA(lv_me_grp).
              IF lv_me_grp IS INITIAL.
                DATA(lo_meent_set) = xco_cp_i18n=>target->metadata_extension->entity( CONV sxco_cds_object_name( lv_object_name ) ).
          ...
          WHEN 'application_log_object'.
            IF lv_subobj_name IS NOT INITIAL.
              ...
              DATA(lo_set_aplo_sub) = xco_cp_i18n=>target->application_log_object->subobject( iv_object_name = CONV sxco_aplo_object_name( lv_object_name ) iv_subobject_name = CONV if_xco_aplo_subobject=>tv_name( lv_subobj_name ) ).
            ...
            ELSE.
              DATA(lo_set_aplo_obj) = xco_cp_i18n=>target->application_log_object->object( iv_name = CONV sxco_aplo_object_name( lv_object_name ) ).
          ...
          WHEN 'business_configuration_object'.
            DATA(lo_bco_set) = xco_cp_i18n=>target->business_configuration_object->object( iv_name = CONV sxco_bco_name( lv_object_name ) ).
          ...
          WHEN 'text_table'.
            ...
            ENDIF.
            DATA(lo_tt_set) = xco_cp_i18n=>target->text_table->record(
...
METHOD handle_list_texts.
    ...
    TRY.
        ...
        CASE lv_target_type.
          WHEN 'data_element'.
            DATA(lo_lt_de) = xco_cp_i18n=>target->data_element->object( CONV sxco_ad_object_name( lv_object_name ) ).
          ...
          WHEN 'domain'.
            ...
            LOOP AT lt_lt_dom_fvs INTO DATA(ls_lt_dom_fv).
              DATA(lo_lt_dom) = xco_cp_i18n=>target->domain->fixed_value( iv_domain_name = CONV sxco_ad_object_name( lv_object_name ) iv_lower_limit = ls_lt_dom_fv ).
          ...
          WHEN 'data_definition'.
            ...
            DATA(lo_lt_ent) = xco_cp_i18n=>target->data_definition->entity( CONV sxco_cds_object_name( lv_object_name ) ).
            ...
            LOOP AT lt_dd_field_names INTO DATA(lv_lt_fn).
              ...
              LOOP AT lt_lt_fld_attrs INTO DATA(lv_lt_fan).
                ...
                DATA(lo_lt_fld) = xco_cp_i18n=>target->data_definition->field( iv_entity_name = CONV sxco_cds_object_name( lv_object_name ) iv_field_name = CONV sxco_cds_field_name( lv_lt_fn ) ).
                ...
                LOOP AT lt_dd_slots INTO DATA(lv_dds).
                  ...
                  IF lv_spras <> lv_orig_spras.
                    ...
                    IF lo_dd_fa IS BOUND.
                      ...
                      DATA(lo_dd_fld2) = xco_cp_i18n=>target->data_definition->field( iv_entity_name = CONV sxco_cds_object_name( lv_object_name ) iv_field_name = CONV sxco_cds_field_name( lv_s_fn ) ).
                ...
                IF sy-subrc = 0.
                  ...
                  LOOP AT lt_lt_dd_pos_attrs INTO DATA(lv_lt_dd_pa).
                    ...
                    DO.
                      ...
                      DATA(lo_lt_dd_fld) = xco_cp_i18n=>target->data_definition->field( iv_entity_name = CONV sxco_cds_object_name( lv_object_name ) iv_field_name = CONV sxco_cds_field_name( lv_lt_fn ) ).
          ...
          WHEN 'metadata_extension'.
            ...
            DATA(lo_lt_meent) = xco_cp_i18n=>target->metadata_extension->entity( CONV sxco_cds_object_name( lv_object_name ) ).
            ...
            LOOP AT lt_me_field_names INTO DATA(lv_lt_mfn).
              ...
              LOOP AT lt_lt_me_attrs INTO DATA(lv_lt_man).
                ...
                DATA(lo_lt_me_tgt) = xco_cp_i18n=>target->metadata_extension->field( iv_metadata_extension_name = CONV sxco_cds_object_name( lv_object_name ) iv_field_name = CONV sxco_cds_field_name( lv_lt_mfn ) ).
                ...
                LOOP AT lt_me_slots INTO DATA(lv_mes).
                  ...
                  IF lv_spras <> lv_orig_spras.
                    ...
                    IF lo_me_fa IS BOUND.
                      ...
                      DATA(lo_me_fld2) = xco_cp_i18n=>target->metadata_extension->field( iv_metadata_extension_name = CONV sxco_cds_object_name( lv_object_name ) iv_field_name = CONV sxco_cds_field_name( lv_m_fn ) ).
                ...
                IF sy-subrc = 0.
                  LOOP AT lt_lt_me_pos_attrs INTO DATA(lv_lt_pan).
                    ...
                    DO.
                      ...
                      DATA(lo_lt_me_p) = xco_cp_i18n=>target->metadata_extension->field( iv_metadata_extension_name = CONV sxco_cds_object_name( lv_object_name ) iv_field_name = CONV sxco_cds_field_name( lv_lt_mfn ) ).
            ...
            ENDLOOP.
          WHEN 'message_class'.
            DATA(lt_lt_mc_nums) = xco_cp_abap_repository=>object->msag->for( CONV sxco_mc_object_name( lv_object_name ) )->messages->all->get_numbers( ).
            LOOP AT lt_lt_mc_nums INTO DATA(ls_lt_mc_num).
              DATA(lo_lt_mc_tgt) = xco_cp_i18n=>target->message_class->message( iv_message_class_name = CONV sxco_mc_object_name( lv_object_name ) iv_message_number = ls_lt_mc_num ).
            ...
            ENDLOOP.
          WHEN 'text_pool'.
            rs_response = build_error( iv_code = 'CLOUD_UNSUPPORTED'
              iv_message = 'list_texts for text_pool is not available with released cloud APIs; use get_translation/set_translation with an explicit text_symbol_id' ). RETURN.
          WHEN 'application_log_object'.
            DATA(lo_lt_aplo) = xco_cp_i18n=>target->application_log_object->object( iv_name = CONV sxco_aplo_object_name( lv_object_name ) ).
          ...
          WHEN 'business_configuration_object'.
            DATA(lo_lt_bco) = xco_cp_i18n=>target->business_configuration_object->object( iv_name = CONV sxco_bco_name( lv_object_name ) ).
...
METHOD get_cds_field_names.
    " Cloud-safe field enumeration. xco_cp_cds=>entity( ) is the universal CDS
    " entity accessor (works for views, view entities, projections, abstract and
    " custom entities alike) and is released for ABAP Cloud. The data_definition( )
    " factory does not resolve every projection on this system ("DDLS ... does not
    " exist"), and the cl_abap_typedescr RTTI fallback is not cloud-safe (it raises
    " a class-based "data type is not released" at runtime) — both are avoided here.
    TRY.
        DATA(lt_fields) = xco_cp_cds=>entity( CONV sxco_cds_object_name( iv_object_name )
                                            )->fields->all->get( ).
  ...
  METHOD resolve_original_language.
    ...
    " XCO's repository-object original language — the same value ADT/Eclipse reports. The generic
    " object factory returns an IF_XCO_AR_OBJECT for ANY repository object type (DTEL, DOMA, DDLS,
    " DDLX, MSAG, CLAS, FUGR, APLO, SMBC), so a single released call covers every translation target.
    " (No TADIR fallback here: direct SELECT on TADIR is not allowed in ABAP for Cloud.)
    TRY.
        ...
        ENDIF.
      CATCH cx_root.
        " XCO could not resolve it (object missing / type unsupported).
    ENDTRY.
...
METHOD get_anno_slots.
    ...
    " UI texts (e.g. @UI.dataPoint.title) are read as non-positional field attributes.
...
METHOD get_me_entity_attr.
    ...
    " headerInfo, enterpriseSearch and selectionVariant. headerInfo/enterpriseSearch/endusertext are
    " named attributes on the ME entity factory; selectionVariant is positional, addressed via for().
    CASE iv_name.
      ...
      " positional selectionVariant.text — addressed via the generic for(); on releases that do not
      " model it for() returns unbound -> caller skips. ($ is literal in ABAP string templates.)
  ...
  METHOD handle_list_text_table.
    " list_texts for a text table (released cloud APIs). The master key fields fix one record;
    " every non-key character-like field is a text attribute. Request shape mirrors set_translation:
    "   object_name             -> database table name (e.g. T005T)
    "   language_key_field_name -> the LANG key field (e.g. SPRAS)
    "   master_key_fields       -> [{ "name":"LAND1", "value":"DE" }, ...] (fixes the record)
    ...
    TRY.
        DATA(lv_spras) = to_spras( lv_language ).
        DATA(lo_language) = xco_cp=>language( lv_spras ).
        DATA(lo_rec) = xco_cp_i18n=>target->text_table->record(
          iv_database_table_name     = CONV sxco_dbt_object_name( lv_object_name )
          it_master_key_fields       = lt_tt_mkf
